...
btn = Button(num,text='clique aqui',command=verificar_numero)
btn.grid(row=2,column=0,padx=10,pady=10)

r_label = Label(num,text="")
...
def verifica_limite():
    ...
    lista_num = list(map(int, entry_num.get().split(',')))
...
label_limite = Label(limite,text='digite o limite: ')
label_limite.grid(row = 0 , column = 0, padx=10,pady=10)

entry_limite= Entry(limite)
entry_limite.grid(row = 1, column = 0, padx=10,pady=10)

label_num = Label(limite,text='digite numeros: ')
label_num.grid(row = 2 , column = 0, padx=10,pady=10)

entry_num= Entry(limite)
entry_num.grid(row = 3, column = 0, padx=10,pady=10)

btn = Button(limite, text='limite ?', command=verifica_limite )
btn.grid(row = 4 , column = 0, padx=10,pady=10)

r_label=Label(limite, text="")
r_label.grid(row = 5, column = 0, padx=10,pady=10)
